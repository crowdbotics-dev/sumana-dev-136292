"""
Django settings for sumana_dev_136292 project.
...
ROOT_URLCONF = 'sumana_dev_136292.urls'
...
WSGI_APPLICATION = 'sumana_dev_136292.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "sumanA Support <support@sumana-dev-136292.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sumana_dev_136292 API",
    "DESCRIPTION": "API documentation for sumana_dev_136292 App",
    "VERSION": "v1",
}
